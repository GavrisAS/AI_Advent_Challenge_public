...
class SimpleAgent:
    ...
    def _prepare_messages_for_request(
        ...
        *,
        ...
        request_messages, memory_metadata, task_prompt_tokens = self._build_request_messages(
            persistent_messages,
            user_message,
        )
    ...
    def _build_request_messages(
        ...
        persistent_messages: list[Message],
        user_message: Message,
    ) -> tuple[list[Message], MemoryPromptMetadata, int]:
        ...
        return request_messages, memory_metadata, task_prompt_tokens
