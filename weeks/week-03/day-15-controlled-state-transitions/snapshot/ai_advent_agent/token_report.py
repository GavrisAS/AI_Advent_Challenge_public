...
class TokenReport:
    ...
    invariants_active: bool = False
    invariants_count: int = 0
    invariants_prompt_tokens_estimated: int = 0
    invariant_conflict: bool = False
    invariant_conflict_count: int = 0
    task_state_active: bool = False
    task_stage: str | None = None
    task_done: bool = False
    task_paused: bool = False
    task_plan_approved: bool = False
    task_validation_passed: bool = False
    task_allowed_next_stages: list[str] = field(default_factory=list)
    task_last_transition_allowed: bool | None = None
    task_prompt_tokens_estimated: int = 0
