...
def handle_status(context: CommandContext, argument: str) -> CommandResult:
    ...
    print(f"  invariants_active: {agent.invariants.active}")
    print(f"  invariants_count: {len(agent.invariants.enabled())}")
    print(f"  task_stage: {agent.task_state.stage or '-'}")
    print(f"  task_paused: {agent.task_state.paused}")
    print(f"  task_plan_approved: {agent.task_state.plan_approved}")
    print(f"  task_validation_passed: {agent.task_state.validation_passed}")
